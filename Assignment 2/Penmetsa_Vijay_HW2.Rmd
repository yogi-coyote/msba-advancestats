...
lm_full$coefficients['Mileage'] * 100
```
Answer: 
For every unit increase in Mileage, the Price goes down by 1.66%
...
Answer: Eliminated predictors: Metallic, CC, Automatic, Doors
...
Answer: Yes. Log transformation helped reduced the prediction errors thus improving out-of-sample prediction performance.
...
Answer: The first predictor removed is Population
...
Answer:
MAE lm_full: 0.8582053 
MAE lm_bwd: 0.8597975


**Q6(c) [1 points]**
Which statistical model do you prefer, `lm_full` or `lm_bwd`? Give reasons.

Answer: I prefer lm_bwd as it is simpler than lm_full with approximately the same MAE.
